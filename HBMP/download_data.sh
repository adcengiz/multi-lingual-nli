...
curl -O http://nlp.stanford.edu/data/glove.840B.300d
...
curl -O http://www.nyu.edu/projects/bowman/multinli/multinli_1.0.zip
...
curl -O http://data.allenai.org.s3.amazonaws.com/downloads/SciTailV1.zip
...
curl -O http://u.cs.biu.ac.il/~nlp/wp-content/uploads/breaking_nli_dataset.zip
